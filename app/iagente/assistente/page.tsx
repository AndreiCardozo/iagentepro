...
export default function AssistentePage() {
  ...
  const handleSetorSelect = (setor: string) => {
    ...
    setTimeout(() => {
      ...
      const mensagem = `Olá! Atuo no setor de ${setor}, e gostaria de ver na prática o IAgente Assistente Pessoal.`
  ...
  const recursos = [
    {
      ...
      items: [
        ...
        "Responde e envia e-mails",
        "Responde mensagens de texto e de áudio no WhatsApp",
        "Marca reuniões e compromissos",
        "Gerencia sua agenda",
        "Faz lembretes de compromissos",
        "Organiza sua vida pessoal e profissional"
      ]
    },
    {
      titulo: "Capacidade Operacional",
      items: [
        "Atua 24/7 sem interrupções",
        "Capaz de 90 atendimentos simultâneos ( 1 IAgente Assistente = 90 Assistentes humanos)",
        "Totalmente humanizada (ninguém saberá que sua assessora é uma inteligência artificial)",
        "Extremamente qualificada e eficiente"
      ]
    },
    {
      titulo: "Qualificação",
      items: [
        "Assistente Multilíngue (atende em 8 idiomas)",
    "Atendimento ativo e receptivo",
        "Atende em multicanais (e-mail, WhatsApp, Instagram, Facebook, telefone)",
        "Conversa, tira dúvidas, responde perguntas e pode atuar como uma amiga"
      ]
    },
    {
      titulo: "Suporte Pessoal",
      items: [
    "Auxilia nas tarefas pessoais do dia a dia",
    "Atende contatos, amigos, famíliares",
        "Responde mensagens de texto e de áudio no WhatsApp e Instagram como um humano",
        "Liga para marcar consulta médica, horário no salão, entre outros"
      ]
    },
    {
      titulo: "Gestão de Agenda",
      items: [
        "Agenda compromissos, reuniões, consultas e exames na agenda pessoal",
    "Cancela e reagenda reuniões e compromissos",
        "Lembra e avisa sobre compromissos com antecedência",
        "Responde e envia e-mails"
      ]
    },
    {
      ...
      items: [
        ...
        "Faz ligações",
        "Atende ligações",
        "Atendimento no Whatsapp, Instagram e Facebook",
        "Atendimento em e-mail"
      ]
    }
  ]
    ...
    <div className="pt-8 pb-16" style={{ background: '#070c14' }}>
      ...
      <div className="container mx-auto px-4 pt-4">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-4xl font-bold text-center mb-4 text-white">ASSISTENTE</h1>
          ...
          <div className="mb-12 card-glass p-6 rounded-xl max-w-7xl mx-auto">
            <div className="w-full aspect-[5/7] md:aspect-[19/7] lg:aspect-[19/7] bg-gray-200 rounded-lg overflow-hidden mb-6 relative aspect-ratio-container">
              <Image
                src="/images/card-assistentepessoal.webp"
                alt="IAgente Assistente"
                fill
                className="object-cover md:hidden"
                style={{ objectPosition: "center" }}
              />
              <Image
                src="/images/bannerhomepage-assistentepessoal.webp"
                alt="IAgente Assistente"
                fill
            ...
            <div className="text-center">
              <Button 
                ...
                aria-label="Abrir modal para falar com o IAgente Assistente"
              >
                Falar com o IAgente
              </Button>
            </div>
      ...
      {/* Segunda Seção - De "IAGENTE ASSISTENTE" até os botões */}
      <section className="py-16" style={{
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-7xl mx-auto">
            <div className="mb-12">
              <h2 className="text-2xl font-bold mb-4 text-center text-lagente text-white">IAGENTE ASSISTENTE</h2>
              <p className="text-lg text-center mb-8 text-gray-300">Especialista em assistência geral</p>
              ...
              <div className="card-glass-no-sweep p-8 rounded-lg shadow-md transition-all duration-300 mb-12" style={{ border: '1px solid #777b7e' }}>
                ...
                <p className="text-lg mb-6" style={{ color: '#acb1b5' }}>
                  O IAgente Assistente é uma solução revolucionária para empresas que desejam
                  otimizar seu processo de assistência geral. Com técnicas avançadas de suporte
                  e organização, nosso IAgente está disponível 24 horas por dia,
                  7 dias por semana, garantindo eficiência e suporte em todas as tarefas necessárias.
                </p>

                <p className="text-lg mb-6" style={{ color: '#acb1b5' }}>
                  Especialista em assistência, extremamente eficiente e qualificado para o
                  cargo de assistente. Treinado com técnicas avançadas de suporte e organização geral.
                </p>
              </div>
            </div>
