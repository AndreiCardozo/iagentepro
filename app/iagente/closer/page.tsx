...
export default function CloserPage() {
  ...
  const handleSetorSelect = (setor: string) => {
    ...
    setTimeout(() => {
      ...
      const mensagem = `Olá! Atuo no setor de ${setor}, e gostaria de ver na prática o IAgente Closer.`
  ...
  const recursos = [
    {
      ...
      items: [
        "Realiza apresentações comerciais personalizadas",
        "Identifica necessidades e objeções do cliente",
        "Aplica técnicas avançadas de persuasão",
        "Negocia condições e preços",
        "Fecha negócios de alto valor",
        "Converte leads qualificados em clientes"
      ]
    },
    {
      ...
      items: [
        ...
        "Estratégias de fechamento personalizadas"
      ]
    },
    {
    ...
    <div className="pt-8 pb-16" style={{ background: '#070c14' }}>
      ...
      <div className="container mx-auto px-4 pt-4">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-4xl font-bold text-center mb-4 text-white">CLOSER</h1>
          ...
          <div className="mb-12 card-glass p-6 rounded-xl max-w-7xl mx-auto">
            <div className="w-full aspect-[5/7] md:aspect-[19/7] lg:aspect-[19/7] bg-gray-200 rounded-lg overflow-hidden mb-6 relative aspect-ratio-container">
              ...
              />
              <Image
                src="/images/bannerhomepage-closer.webp"
                alt="IAgente Closer"
                fill
            ...
            <div className="text-center">
              <Button 
                ...
                aria-label="Abrir modal para falar com o IAgente Closer"
              >
                Falar com o IAgente
              </Button>
            </div>
      ...
      {/* Segunda Seção - De "IAGENTE CLOSER" até os botões */}
      <section className="py-16" style={{
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-7xl mx-auto">
            <div className="mb-12">
              <h2 className="text-2xl font-bold mb-4 text-center text-lagente text-white">IAGENTE CLOSER</h2>
              <p className="text-lg text-center mb-8 text-gray-300">Especialista em fechamento de vendas</p>
              ...
              <div className="card-glass-no-sweep p-8 rounded-lg shadow-md transition-all duration-300 mb-12" style={{ border: '1px solid #777b7e' }}>
                ...
                <p className="text-lg mb-6" style={{ color: '#acb1b5' }}>
                  O IAgente Closer é uma solução revolucionária para empresas que desejam
                  otimizar seu processo de fechamento de vendas. Com técnicas avançadas de persuasão
                  e programação neurolinguística, nosso IAgente está disponível 24 horas por dia,
                  7 dias por semana, garantindo eficiência e precisão em fechar negócios de alto valor.
                </p>

                <p className="text-lg mb-6" style={{ color: '#acb1b5' }}>
                  Especialista em fechamento, extremamente eficiente e qualificado para o
                  cargo de closer. Treinado com técnicas avançadas de persuasão e fechamento de vendas.
                </p>
              </div>
            </div>
