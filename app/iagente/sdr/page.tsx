...
export default function SdrPage() {
  ...
  const handleSetorSelect = (setor: string) => {
    ...
    setTimeout(() => {
      ...
      const mensagem = `Olá! Atuo no setor de ${setor}, e gostaria de ver na prática o IAgente SDR.`
  ...
  const recursos = [
    {
      ...
      items: [
        "Realiza primeiro contato com leads",
        "Qualifica leads de acordo com critérios estabelecidos",
        "Identifica oportunidades de negócio",
        "Segmenta leads por interesse e potencial",
        "Coleta informações relevantes dos prospects",
        "Avalia capacidade de compra dos leads"
      ]
    },
    {
      titulo: "Comunicação",
      items: [
        "Atendimento multicanal (WhatsApp, telefone, e-mail)",
        "Comunicação natural e humanizada",
        "Responde dúvidas e objeções",
        "Apresenta soluções personalizadas",
        "Mantém conversas ativas e engajadas"
      ]
    },
    {
      titulo: "Gestão",
      items: [
        "Agenda reunião com o CLOSER (especialista em vendas)",
        "Envia mensagem imediata de confirmação do agendamento",
        "Envia lembrete da consulta ou reunião uma hora antes",
        "Cancela e reagenda reuniões de vendas",
        "Acompanha o Lead do primeiro contato até o atendimento do Closer",
        "Qualifica e segmenta os leads no CRM"
      ]
    }
  ]
    ...
    <div className="pt-8 pb-16" style={{ background: '#070c14' }}>
      ...
      <div className="container mx-auto px-4 pt-4">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-4xl font-bold text-center mb-4 text-white">SDR</h1>
          ...
          <div className="mb-12 card-glass p-6 rounded-xl max-w-7xl mx-auto">
            <div className="w-full aspect-[5/7] md:aspect-[19/7] lg:aspect-[19/7] bg-gray-200 rounded-lg overflow-hidden mb-6 relative aspect-ratio-container">
              ...
              />
              <Image
                src="/images/bannerhomepage-sdr.webp"
                alt="IAgente SDR"
                fill
            ...
            <div className="text-center">
              <Button 
                ...
                aria-label="Abrir modal para falar com o IAgente SDR"
              >
                Falar com o IAgente
              </Button>
            </div>
      ...
      {/* Segunda Seção - De "IAGENTE SDR" até os botões */}
      <section className="py-16" style={{
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-7xl mx-auto">
            <div className="mb-12">
              <h2 className="text-2xl font-bold mb-4 text-center text-lagente text-white">IAGENTE SDR</h2>
              <p className="text-lg text-center mb-8 text-gray-300">Especialista em qualificação de leads</p>
              ...
              <div className="card-glass-no-sweep p-8 rounded-lg shadow-md transition-all duration-300 mb-12" style={{ border: '1px solid #777b7e' }}>
                ...
                <p className="text-lg mb-6" style={{ color: '#acb1b5' }}>
                  O IAgente SDR é uma solução revolucionária para empresas que desejam
                  otimizar seu processo de qualificação de leads. Com técnicas avançadas
                  de qualificação e segmentação, nosso IAgente está disponível 24 horas por dia,
                  7 dias por semana, garantindo eficiência e precisão na qualificação de prospects.
                </p>

                <p className="text-lg mb-6" style={{ color: '#acb1b5' }}>
                  Especialista em qualificação, extremamente eficiente e qualificado para o
                  cargo de SDR. Treinado com técnicas avançadas de qualificação e segmentação de leads.
                </p>
              </div>
            </div>
