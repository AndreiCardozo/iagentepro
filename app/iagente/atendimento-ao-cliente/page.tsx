...
export default function AtendimentoAoClientePage() {
  ...
  const handleSetorSelect = (setor: string) => {
    ...
    setTimeout(() => {
      ...
      const mensagem = `Olá! Atuo no setor de ${setor}, e gostaria de ver na prática o IAgente Atendimento ao Cliente.`
  ...
  const recursos = [
    ...
    },
    {
      ...
      items: [
        ...
        "Orientação sobre produtos/serviços",
        "Processamento de solicitações",
        "Acompanhamento de tickets",
        "Suporte a produtos ou serviços com excelência"
      ]
    },
    {
    ...
    <div className="pt-8 pb-16" style={{ background: '#070c14' }}>
      ...
      <div className="container mx-auto px-4 pt-4">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-4xl font-bold text-center mb-4 text-white">ATENDIMENTO AO CLIENTE</h1>
          ...
          <div className="mb-12 card-glass p-6 rounded-xl max-w-7xl mx-auto">
            <div className="w-full aspect-[5/7] md:aspect-[19/7] lg:aspect-[19/7] bg-gray-200 rounded-lg overflow-hidden mb-6 relative aspect-ratio-container">
              <Image
                src="/images/card-sac.webp"
                alt="IAgente Atendimento ao Cliente"
                fill
                className="object-cover md:hidden"
                style={{ objectPosition: "center" }}
              />
              <Image
                src="/images/bannerhomepage-sac.webp"
                alt="IAgente Atendimento ao Cliente"
                fill
            ...
            <div className="text-center">
              <Button 
                ...
                aria-label="Abrir modal para falar com o IAgente de Atendimento ao Cliente"
              >
                Falar com o IAgente
              </Button>
            </div>
      ...
      {/* Segunda Seção - De "IAGENTE ATENDIMENTO" até os botões */}
      <section className="py-16" style={{
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-7xl mx-auto">
            <div className="mb-12">
              <h2 className="text-2xl font-bold mb-4 text-center text-lagente text-white">IAGENTE ATENDIMENTO AO CLIENTE</h2>
              <p className="text-lg text-center mb-8 text-gray-300">Especialista em atendimento ao cliente</p>
              ...
              <div className="card-glass-no-sweep p-8 rounded-lg shadow-md transition-all duration-300 mb-12" style={{ border: '1px solid #777b7e' }}>
                ...
                <p className="text-lg mb-6" style={{ color: '#acb1b5' }}>
                  O IAgente Atendimento ao Cliente é uma solução revolucionária para empresas que desejam
                  otimizar seu processo de atendimento. Com técnicas avançadas de comunicação
                  e resolução de problemas, nosso IAgente está disponível 24 horas por dia,
                  7 dias por semana, garantindo eficiência e satisfação do cliente.
                </p>

                <p className="text-lg mb-6" style={{ color: '#acb1b5' }}>
                  Especialista em atendimento, extremamente eficiente e qualificado para o
                  cargo de atendente. Treinado com técnicas avançadas de comunicação e resolução de problemas.
                </p>
              </div>
            </div>
