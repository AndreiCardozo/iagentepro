...
export default function RecuperadorPage() {
  ...
  const handleSetorSelect = (setor: string) => {
    ...
    setTimeout(() => {
      ...
      const mensagem = `Olá! Atuo no setor de ${setor}, e gostaria de ver na prática o IAgente Recuperador.`
  ...
  const recursos = [
    {
      ...
      items: [
        ...
        "Reativa leads abandonados",
        "Recupera carrinhos abandonados",
        "Reconquista clientes inativos",
        "Aplica estratégias de retenção",
        "Otimiza processos de recuperação"
      ]
    },
    {
      titulo: "Estratégias de Reconquista",
      items: [
    ...
    },
    {
      ...
      items: [
        "Segmentação de leads recuperados",
        "Acompanhamento de conversões",
        "Relatórios de performance",
        "Análise de métricas",
        "Otimização de processos de recuperação"
      ]
    }
  ]
    ...
    <div className="pt-8 pb-16" style={{ background: '#070c14' }}>
      ...
      <div className="container mx-auto px-4 pt-4">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-4xl font-bold text-center mb-4 text-white">RECUPERADOR</h1>
          ...
          <div className="mb-12 card-glass p-6 rounded-xl max-w-7xl mx-auto">
            <div className="w-full aspect-[5/7] md:aspect-[19/7] lg:aspect-[19/7] bg-gray-200 rounded-lg overflow-hidden mb-6 relative aspect-ratio-container">
              <Image
                src="/images/card-recuperadordevenda.webp"
                alt="IAgente Recuperador"
                fill
                className="object-cover md:hidden"
                style={{ objectPosition: "center" }}
              />
              <Image
                src="/images/bannerhomepage-recuperadordevendas.webp"
                alt="IAgente Recuperador"
                fill
            ...
            <div className="text-center">
              <Button 
                ...
                aria-label="Abrir modal para falar com o IAgente Recuperador"
              >
                Falar com o IAgente
              </Button>
            </div>
      ...
      {/* Segunda Seção - De "IAGENTE RECUPERADOR" até os botões */}
      <section className="py-16" style={{
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-7xl mx-auto">
            <div className="mb-12">
              <h2 className="text-2xl font-bold mb-4 text-center text-lagente text-white">IAGENTE RECUPERADOR</h2>
              <p className="text-lg text-center mb-8 text-gray-300">Especialista em recuperação de vendas</p>
              ...
              <div className="card-glass-no-sweep p-8 rounded-lg shadow-md transition-all duration-300 mb-12" style={{ border: '1px solid #777b7e' }}>
                ...
                <p className="text-lg mb-6" style={{ color: '#acb1b5' }}>
                  O IAgente Recuperador é uma solução revolucionária para empresas que desejam
                  otimizar seu processo de recuperação de vendas perdidas. Com técnicas avançadas
                  de reengajamento e reconversão, nosso IAgente está disponível 24 horas por dia,
                  7 dias por semana, garantindo eficiência e precisão na recuperação de oportunidades perdidas.
                </p>

                <p className="text-lg mb-6" style={{ color: '#acb1b5' }}>
                  Especialista em recuperação, extremamente eficiente e qualificado para o
                  cargo de recuperador. Treinado com técnicas avançadas de reengajamento e reconversão.
                </p>
              </div>
            </div>
