...
export default function CobradorPage() {
  ...
  const handleSetorSelect = (setor: string) => {
    ...
    setTimeout(() => {
      ...
      const mensagem = `Olá! Atuo no setor de ${setor}, e gostaria de ver na prática o IAgente Cobrador.`
  ...
  const recursos = [
    {
      titulo: "Cobrança Eficiente",
      items: [
        "Realiza cobranças de forma humanizada",
        "Identifica melhores horários para contato",
        "Aplica técnicas de persuasão para pagamento",
        "Negocia prazos e condições",
        "Acompanha pagamentos em atraso",
        "Gera relatórios de cobrança"
      ]
    },
    {
      ...
      items: [
        ...
        "Gestão de objeções de pagamento",
        "Follow-up de cobranças"
      ]
    },
    {
      ...
      items: [
        ...
        "Otimização de processos de cobrança"
      ]
    }
  ]
    ...
    <div className="pt-8 pb-16" style={{ background: '#070c14' }}>
      ...
      <div className="container mx-auto px-4 pt-4">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-4xl font-bold text-center mb-4 text-white">COBRADOR</h1>
          ...
          <div className="mb-12 card-glass p-6 rounded-xl max-w-7xl mx-auto">
            <div className="w-full aspect-[5/7] md:aspect-[19/7] lg:aspect-[19/7] bg-gray-200 rounded-lg overflow-hidden mb-6 relative aspect-ratio-container">
              <Image
                src="/images/card-cobrador.webp"
                alt="IAgente Cobrador"
                fill
                className="object-cover md:hidden"
                style={{ objectPosition: "center" }}
              />
              <Image
                src="/images/bannerhomepage-cobrador.webp"
                alt="IAgente Cobrador"
                fill
            ...
            <div className="text-center">
              <Button 
                ...
                aria-label="Abrir modal para falar com o IAgente Cobrador"
              >
                Falar com o IAgente
              </Button>
            </div>
      ...
      {/* Segunda Seção - De "IAGENTE COBRADOR" até os botões */}
      <section className="py-16" style={{
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-7xl mx-auto">
            <div className="mb-12">
              <h2 className="text-2xl font-bold mb-4 text-center text-lagente text-white">IAGENTE COBRADOR</h2>
              <p className="text-lg text-center mb-8 text-gray-300">Especialista em cobrança e recuperação de crédito</p>
              ...
              <div className="card-glass-no-sweep p-8 rounded-lg shadow-md transition-all duration-300 mb-12" style={{ border: '1px solid #777b7e' }}>
                ...
                <p className="text-lg mb-6" style={{ color: '#acb1b5' }}>
                  O IAgente Cobrador é uma solução revolucionária para empresas que desejam
                  otimizar seu processo de cobrança e recuperação de crédito. Com técnicas avançadas
                  de negociação e gestão de relacionamento, nosso IAgente está disponível 24 horas por dia,
                  7 dias por semana, garantindo eficiência e precisão na recuperação de valores em atraso.
                </p>

                <p className="text-lg mb-6" style={{ color: '#acb1b5' }}>
                  Especialista em cobrança, extremamente eficiente e qualificado para o
                  cargo de cobrador. Treinado com técnicas avançadas de negociação e recuperação de crédito.
                </p>
              </div>
            </div>
