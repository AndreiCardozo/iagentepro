...
export default function SocialMidiaPage() {
  ...
  const handleSetorSelect = (setor: string) => {
    ...
    setTimeout(() => {
      ...
      const mensagem = `Olá! Atuo no setor de ${setor}, e gostaria de ver na prática o IAgente Social Mídia.`
    ...
    <div className="pt-8 pb-16" style={{ background: '#070c14' }}>
      ...
      <div className="container mx-auto px-4 pt-4">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-4xl font-bold text-center mb-4 text-white">SOCIAL MÍDIA</h1>
          ...
          <div className="mb-12 card-glass p-6 rounded-xl max-w-7xl mx-auto">
            <div className="w-full aspect-[5/7] md:aspect-[19/7] lg:aspect-[19/7] bg-gray-200 rounded-lg overflow-hidden mb-6 relative aspect-ratio-container">
              <Image
                src="/images/card-social.webp"
                alt="IAgente Social Mídia"
                fill
                className="object-cover md:hidden"
                style={{ objectPosition: "center" }}
              />
              <Image
                src="/images/bannerhomepage-socialmedia.webp"
                alt="IAgente Social Mídia"
                fill
            ...
            <div className="text-center">
              <Button 
                ...
                aria-label="Abrir modal para falar com o IAgente de Social Mídia"
              >
                Falar com o IAgente
              </Button>
            </div>
      ...
      {/* Segunda Seção - De "IAGENTE SOCIAL MÍDIA" até os botões */}
      <section className="py-16" style={{
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-7xl mx-auto">
            <div className="mb-12">
              <h2 className="text-2xl font-bold mb-4 text-center text-lagente text-white">IAGENTE SOCIAL MÍDIA</h2>
              <p className="text-lg text-center mb-8 text-gray-300">Especialista em gestão de redes sociais</p>
              ...
              <div className="card-glass-no-sweep p-8 rounded-lg shadow-md transition-all duration-300 mb-12" style={{ border: '1px solid #777b7e' }}>
                ...
                <p className="text-lg mb-6" style={{ color: '#acb1b5' }}>
                  O IAgente Social Mídia é uma solução revolucionária para empresas que desejam
                  otimizar sua presença digital. Com técnicas avançadas de criação de conteúdo
                  e gestão de redes sociais, nosso IAgente está disponível 24 horas por dia,
                  7 dias por semana, garantindo eficiência e engajamento nas redes sociais.
                </p>

                <p className="text-lg mb-6" style={{ color: '#acb1b5' }}>
                  Especialista em mídias sociais, extremamente eficiente e qualificado para o
                  cargo de social media manager. Treinado com técnicas avançadas de criação de conteúdo e gestão de redes.
                </p>
              </div>
            </div>
