...
export default function ProspectorPage() {
  ...
  const handleSetorSelect = (setor: string) => {
    ...
    setTimeout(() => {
      ...
      const mensagem = `Olá! Atuo no setor de ${setor}, e gostaria de ver na prática o IAgente Prospector.`
  ...
  const recursos = [
    {
      titulo: "Prospecção de Leads",
      items: [
        "Identifica leads qualificados",
        "Realiza pesquisas de mercado",
        "Gera listas de prospects",
        "Analisa perfis de clientes potenciais",
        "Segmenta leads por interesse",
        "Prioriza oportunidades de negócio"
      ]
    },
    {
      titulo: "Contato e Qualificação",
      items: [
        "Realiza primeiro contato com prospects",
        "Qualifica leads de acordo com critérios",
        "Coleta informações relevantes",
        "Avalia potencial de conversão",
        "Identifica necessidades do cliente"
      ]
    },
    {
      titulo: "Gestão de Pipeline",
      items: [
        "Organiza leads no CRM",
        "Acompanha progresso de prospects",
        "Atualiza status de leads",
        "Gera relatórios de prospecção",
        "Otimiza processos de captação"
      ]
    }
  ]
    ...
    <div className="pt-8 pb-16" style={{ background: '#070c14' }}>
      ...
      <div className="container mx-auto px-4 pt-4">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-4xl font-bold text-center mb-4 text-white">PROSPECTOR</h1>
          ...
          <div className="mb-12 card-glass p-6 rounded-xl max-w-7xl mx-auto">
            <div className="w-full aspect-[5/7] md:aspect-[19/7] lg:aspect-[19/7] bg-gray-200 rounded-lg overflow-hidden mb-6 relative aspect-ratio-container">
              <Image
                src="/images/card-prospector.webp"
                alt="IAgente Prospector"
                fill
                className="object-cover md:hidden"
                style={{ objectPosition: "center" }}
              />
              <Image
                src="/images/bannerhomepage-prospector.webp"
                alt="IAgente Prospector"
                fill
            ...
            <div className="text-center">
              <Button 
                ...
                aria-label="Abrir modal para falar com o IAgente Prospector"
              >
                Falar com o IAgente
              </Button>
            </div>
      ...
      {/* Segunda Seção - De "IAGENTE PROSPECTOR" até os botões */}
      <section className="py-16" style={{
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-7xl mx-auto">
            <div className="mb-12">
              <h2 className="text-2xl font-bold mb-4 text-center text-lagente text-white">IAGENTE PROSPECTOR</h2>
              <p className="text-lg text-center mb-8 text-gray-300">Especialista em prospecção de leads</p>
              ...
              <div className="card-glass-no-sweep p-8 rounded-lg shadow-md transition-all duration-300 mb-12" style={{ border: '1px solid #777b7e' }}>
                ...
                <p className="text-lg mb-6" style={{ color: '#acb1b5' }}>
                  O IAgente Prospector é uma solução revolucionária para empresas que desejam
                  otimizar seu processo de captação e prospecção de leads qualificados. Com capacidade de prospectar milhares de leads
                  diariamente, nosso IAgente está disponível 24 horas por dia, 7 dias por semana,
                  garantindo eficiência e precisão em gerar leads qualificados e melhores oportunidades de negócio.
                </p>

                <p className="text-lg mb-6" style={{ color: '#acb1b5' }}>
                  Especialista em prospecção, extremamente eficiente e qualificado para o
                  cargo de prospector. Treinado com técnicas avançadas captação e prospecção de leads.
                </p>
              </div>
            </div>
